...
public class GarbageLoader {
	...
	public static final float NAST_ROT_CUTOFF = .3f;
	public static final float NAST_STALE_CUTOFF = .7f;
	...
	public GarbageLoader(String file) {
	...
	public GarbageItem generateNewGarbageItem() {
		generate_identifier();
		load_from_identifier();
		return new GarbageItem(name, image, type, tier, rand.nextFloat());
	}
